...
2. This application likely uses Vercel AI SDK. Instrument your project with Laminar using the installed skill or the docs:
...
- install skills needed to instrument your app
...
registerTelemetry(new LaminarAiSdkTelemetry({
  laminarOptions: {
    projectApiKey: prosess.env.LMNR_PROJECT_API_KEY,
